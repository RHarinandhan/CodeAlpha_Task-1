...
# MUSIC RECOMMDATION SYSTEM Task given by CodeAlpha
# Machine Learning Internship at CodeAlpha Submitted by R.Harinandhan as Machine Learning Intern
...
# Read csv file containing data. CSV file I have taken from the kaggle All those are music links
...
# Creating model here we are using activation function as relu . Its an activation function
...
"""RELU :  z rectified linear activation function or ReLU for short is a piecewise linear function that will output the input directly if it is positive, 
otherwise, it will outeroThe."""
model = Sequential()
...
# Text or heading's
st.markdown("<h2 style='text-align: center; color: white;'><b>Spotify's recommendation system Done By Harinandhan</b></h2>", unsafe_allow_html=True)
...
# Normal text
st.markdown("<h5 style='text-align: center; color: grey;'><b>Music Recommended with artist names</b></h5>", unsafe_allow_html=True)
...
# Lets execute the code by running the command as streamlit run app.py in terminal
# This is the execution project task done by Harinandhan using Machine Learning
#Task given by CodeAlpha Interships